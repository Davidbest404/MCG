...
if exist "MCG_Client.exe" (
    echo    [1] V Main Client (MCG_Client.exe)
) else (
    echo    [1] X Main Client (MISSING!)
)

if exist "ChatWindow.exe" (
    echo    [2] V Chat Window (ChatWindow.exe)
) else (
    echo    [2] X Chat Window (MISSING!)
)

if exist "MapWindows.exe" (
    echo    [3] V Map Window (MapWindows.exe)
) else (
    echo    [3] X Map Window (MISSING!)
)

if exist "StatusWindow.exe" (
    echo    [4] V Status Window (StatusWindow.exe)
) else (
    echo    [4] X Status Window (MISSING!)
)
